                    ...
                    Row(
                      ...
                      children: [
                        ...
                        ElevatedButton(
                          onPressed: () {
                            final appliedMinCal =
                                _parseNumericInput(minCalController.text);
                            final appliedMaxCal =
                                _parseNumericInput(maxCalController.text);
                            final appliedMinProtein =
                                _parseNumericInput(minProteinController.text);
                            final appliedMaxCarbs =
                                _parseNumericInput(maxCarbsController.text);
                            final appliedMaxFat =
                                _parseNumericInput(maxFatController.text);
                            ...
                            provider.setMacroThresholds(
                              minProtein:
                                  sd.contains('High-Protein') ? appliedMinProtein : null,
                              maxCarbs:
                                  sd.contains('Low-Carb') ? appliedMaxCarbs : null,
                              maxFat:
                                  sd.contains('Low-Fat') ? appliedMaxFat : null,
                            );
                            provider.setManualIngredientNames(
                              manualNames.isEmpty ? null : manualNames.toList(),
                            );
                            Navigator.pop(context);
                            provider.getHybridRecommendations();
                          },
